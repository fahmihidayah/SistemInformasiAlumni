	                ...
	                <div id="menu-container">
	                    ...
	                    <nav id="main-menu">
                            ...
                            <ul class="menu">
	                            ...
	                            <li class="menu-item-simple-parent current_page_item"><div><a href="#">PROFILE</a></div></li>
                   ...
                   <!-- **Blog-post - Starts** --> 
                    <article class="blog-post type3">
                        ...
                        <div class="entry-thumb">
                            ...
                            <div class="dt-sc-team type3">
                                <div class="image "><img class="asik" src="http://placehold.it/160x160&text=Team" alt="iamge"/></div>
                                <!-- **team-details - Starts** -->
                    ...
                    <div class="column dt-sc-one-fourth first">
                        ...
                        <div class="entry-detail">
							<div style="text-left: right; padding-bottom: 50px; padding-left:55px; width:80%;"> 
							<td class="cbm cba tc cbo"><table class="ca ca1"><tbody><tr><td>&nbsp;</td><td>2001</td><td>2002</td><td>2003</td><td>2004</td><td>2005</td><td class="cr">2006</td></tr><tr><td>2007</td><td>2008</td><td>2009</td><td>2010</td><td>2011</td><td>2012</td><td title="This date is marked because it is the current date in this time zone. It will disappear if you print the calendar." class="cr chi">2013</td></tr></tbody></table></td>
							</div>
							
                              
                                            <div class="image" style="text-align: center;"><img src="http://placehold.it/160x160&text=Team" alt="iamge"/></div>
                                            <!-- **team-details - Starts** -->
                            ...
                            <div class="project-details">
                                ...
                                <ul class="client-details">
                                    ...
                                    <li>
                                        <p><i class="fa fa-globe"></i><span>Job:</span></br> Architecture & Interior Design </p>
                                    </li>
                                    <li>
