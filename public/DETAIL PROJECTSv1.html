	        	...
	        	<div class="container" >
	                ...
	                <div id="menu-container">
	                    ...
	                    <nav id="main-menu">
                            ...
                            <ul class="menu">
	                            <li class="menu-item-simple-parent "><div><a href="#">HOME</a></div></li>
	                            <li class="menu-item-simple-parent "><div><a href="#">PROFILE</a></div></li>
                                <li class="menu-item-simple-parent current_page_item"><div><a href="#">PROJECTS</a></div>       </li>
                   ...
                   <!-- **Blog-post - Starts** --> 
                    ...
                    <div class="ls-slide" data-ls="slidedelay:10000;transition2d:4;">
                        <img src="images/projects/arsitektur-ganbei (4).jpg" data-src="images/projects/arsitektur-ganbei (4).jpg" class="ls-bg" alt="bg2" />
                            ...
                            <p> <input value="POST" name="submit" class="" type="submit"> </p>
                        </form>
                            </div>
                        ...
                        <div class="entry-detail">
                            ...
                            <h3>Kate and Jade With Glasses</h3>
                            <p>Located  at Mega Kuningan, The Golden Triangle of Jakarta's central Business District. Bottega Ristorante  is one of the newest european concept  restaurant with modern touch in the capital of Indonesia.  The chosen concept for this particular project is "La Dolce Vita", meaning the good life, a mixing of posh and  classy while still taking industrial design as the glue between the two. The restaurant itself is a freestanding building at Danamon Bank Tower (Menara Bank Danamon) area.  Taking into considerations that the area is full of office towers and same looking buildings, Bottega Ristorante is built to be a breath of fresh air and truly remind people to live "La Dolce Vita".</p>
                            <div class="dt-sc-margin30"></div>
                            <h6><b>Features</b> </h6>
                            <ul class="dt-sc-fancy-list arrow type2">
                                <li>Proin consectetur orci sit amet sem blandit, tincidunt ornare odio pretium.</li>
                                <li>Sed molestie urna non consectetur auctor.</li>
                                <li>Aenean vitae mi in justo suscipit egestas vel id leo.</li>
                                <li>Nullam congue diam id odio convallis, sit amet ultricies dui eleifend.</li>
                                <li>Vivamus scelerisque leo nec vulputate blandit.</li>
                            </ul>
